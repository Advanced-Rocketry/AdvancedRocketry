...
public interface IDataHandler {
	 ...
	 */
	int extractData(int maxAmount, DataStorage.DataType type, Direction dir, boolean commit);
	 ...
	 */
	int addData(int maxAmount, DataStorage.DataType type, Direction dir, boolean commit);
