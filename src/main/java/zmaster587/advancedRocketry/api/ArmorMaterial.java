...
public class ArmorMaterial implements IArmorMaterial {
   ...
   public ArmorMaterial(String name, int damage, int[] damageReductionArray, int enchange, SoundEvent sound, float toughness, float noIdea, Supplier<Ingredient> repair) {
      this.name = name;
