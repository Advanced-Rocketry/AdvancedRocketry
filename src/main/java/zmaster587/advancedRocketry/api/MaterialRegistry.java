...
public class MaterialRegistry {
	...
	public static enum Materials {
		...
		TIN("Tin", "pickaxe", 2, 0xcdd5d8, AllowedProducts.PLATE.getFlagValue() | AllowedProducts.INGOT.getFlagValue() | AllowedProducts.NUGGET.getFlagValue() | AllowedProducts.DUST.getFlagValue()),
