...
import zmaster587.advancedRocketry.tile.TilePressurizedTank;
...
import zmaster587.advancedRocketry.tile.infrastructure.TileRocketControlCenter;
...
public class AdvancedRocketryTileEntityType {
	...
	public static TileEntityType<TileRocketControlCenter> TILE_MONITORIING_STATION;
	...
	public static TileEntityType<TileSatelliteControlCenter> TILE_SAT_CONTROL;
	public static TileEntityType<TileSatelliteAssembler> TILE_SAT_BUILDER;
	...
	public static TileEntityType<TilePressurizedTank> TILE_FLUID_TANK;
	...
	public static TileEntityType<TileRocketAssembler> TILE_ROCKET_BUILDER;
	...
	{
		TILE_WIRELESS_TRANSCIEVER = TileEntityType.Builder.create(TileWirelessTransciever::new, AdvancedRocketryBlocks.blockTransceiver).build(null);
		...
		TILE_MONITORIING_STATION = TileEntityType.Builder.create(TileRocketControlCenter::new, AdvancedRocketryBlocks.blockRocketControlCenter).build(null);
		TILE_GUIDANCE_COMPUTER_HATCH = TileEntityType.Builder.create(TileGuidanceComputerAccessHatch::new, AdvancedRocketryBlocks.blockGuidanceComputerAccessHatch).build(null);
		...
		TILE_MICROWAVE_RECIEVER = TileEntityType.Builder.create(TileMicrowaveReciever::new, AdvancedRocketryBlocks.blockMicrowaveReceiver).build(null);
		...
		TILE_ELECTROLYSER = TileEntityType.Builder.create(TileElectrolyser::new, AdvancedRocketryBlocks.blockElectrolyzer).build(null);
		...
		TILE_ASTROBODY_DATA = TileEntityType.Builder.create(TileAstrobodyDataProcessor::new, AdvancedRocketryBlocks.blockAstrobodyDataProcessor).build(null);
		...
		TILE_GRAVITY_CONTROLLER = TileEntityType.Builder.create(TileAreaGravityController::new, AdvancedRocketryBlocks.blockAreaGravityController).build(null);
		...
		TILE_SPACE_LASER = TileEntityType.Builder.create(TileOrbitalLaserDrill::new, AdvancedRocketryBlocks.blockOrbitalLaserDrill).build(null);
		...
		TILE_OXYGEN_CHARGER = TileEntityType.Builder.create(TileGasChargePad::new, AdvancedRocketryBlocks.blockGasChargePad).build(null);
		...
		TILE_SAT_CONTROL = TileEntityType.Builder.create(TileSatelliteControlCenter::new, AdvancedRocketryBlocks.blockSatelliteControlCenter).build(null);
		TILE_SAT_BUILDER = TileEntityType.Builder.create(TileSatelliteAssembler::new, AdvancedRocketryBlocks.blockSatelliteAssembler).build(null);
		...
		TILE_WARP_SHIP_CONTROLLER = TileEntityType.Builder.create(TileWarpController::new, AdvancedRocketryBlocks.blockWarpController).build(null);
		TILE_ATM_DETECTOR = TileEntityType.Builder.create(TileAtmosphereDetector::new, AdvancedRocketryBlocks.blockAtmosphereDetector).build(null);
		TILE_FLUID_TANK = TileEntityType.Builder.create(TilePressurizedTank::new, AdvancedRocketryBlocks.blockPressureTank).build(null);
		...
		TILE_ROCKET_BUILDER = TileEntityType.Builder.create(TileRocketAssembler::new, AdvancedRocketryBlocks.blockRocketAssembler).build(null);
		...
		TILE_SATELLITE_HATCH = TileEntityType.Builder.create(TileSatelliteHatch::new, AdvancedRocketryBlocks.blockSatelliteBay).build(null);
		TILE_SOLAR_ARRAY = TileEntityType.Builder.create(TileSolarArray::new, AdvancedRocketryBlocks.blockSolarArray).build(null);
	...
	public static void registerTileEntityTypesToBlocks()
	{
		...
		((BlockTile)AdvancedRocketryBlocks.blockGasChargePad)._setTile(AdvancedRocketryTileEntityType.TILE_OXYGEN_CHARGER);
		((BlockTile)AdvancedRocketryBlocks.blockOxygenVent)._setTile(AdvancedRocketryTileEntityType.TILE_OXYGEN_VENT);
		((BlockTile)AdvancedRocketryBlocks.blockRocketAssembler)._setTile(AdvancedRocketryTileEntityType.TILE_ROCKET_BUILDER);
		...
		((BlockTile)AdvancedRocketryBlocks.blockRocketControlCenter)._setTile(AdvancedRocketryTileEntityType.TILE_MONITORIING_STATION);

		((BlockTile)AdvancedRocketryBlocks.blockWarpController)._setTile(AdvancedRocketryTileEntityType.TILE_WARP_SHIP_CONTROLLER);

		((BlockTile)AdvancedRocketryBlocks.blockSatelliteAssembler)._setTile(AdvancedRocketryTileEntityType.TILE_SAT_BUILDER);

		((BlockTile)AdvancedRocketryBlocks.blockSatelliteControlCenter)._setTile(AdvancedRocketryTileEntityType.TILE_SAT_CONTROL);

		((BlockTile)AdvancedRocketryBlocks.blockMicrowaveReceiver)._setTile(AdvancedRocketryTileEntityType.TILE_MICROWAVE_RECIEVER);
		...
		((BlockARHatch)AdvancedRocketryBlocks.blockSatelliteBay)._setTile(AdvancedRocketryTileEntityType.TILE_SATELLITE_HATCH);
		...
		((BlockARHatch)AdvancedRocketryBlocks.blockGuidanceComputerAccessHatch)._setTile(AdvancedRocketryTileEntityType.TILE_GUIDANCE_COMPUTER_HATCH);
		...
		((BlockTile)AdvancedRocketryBlocks.blockElectrolyzer)._setTile(AdvancedRocketryTileEntityType.TILE_ELECTROLYSER);
		((BlockTile)AdvancedRocketryBlocks.blockTerraformer)._setTile(AdvancedRocketryTileEntityType.TILE_TERRAFORMER);
		((BlockTile)AdvancedRocketryBlocks.blockAstrobodyDataProcessor)._setTile(AdvancedRocketryTileEntityType.TILE_ASTROBODY_DATA);
		...
		((BlockTile)AdvancedRocketryBlocks.blockTransceiver)._setTile(AdvancedRocketryTileEntityType.TILE_WIRELESS_TRANSCIEVER);

		//Configurable stuff
		((BlockTile)AdvancedRocketryBlocks.blockAreaGravityController)._setTile(AdvancedRocketryTileEntityType.TILE_GRAVITY_CONTROLLER);
		
		((BlockTile)AdvancedRocketryBlocks.blockOrbitalLaserDrill)._setTile(AdvancedRocketryTileEntityType.TILE_SPACE_LASER);
