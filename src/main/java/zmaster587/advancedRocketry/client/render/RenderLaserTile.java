...
public class RenderLaserTile extends TileEntityRenderer<TileSpaceLaser> {
	
	
	public RenderLaserTile(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}
	
	@Override
	public void render(TileSpaceLaser tileentity, float partialTicks, MatrixStack matrix,
