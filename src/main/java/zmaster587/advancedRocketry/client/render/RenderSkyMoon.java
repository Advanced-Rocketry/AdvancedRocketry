...
public class RenderSkyMoon extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        GL11.glPushMatrix();
        f6 = 1.0F - mc.theWorld.getRainStrength(partialTicks);
        f7 = 0.0F;
        f8 = 0.0F;
        f9 = 0.0F;
        ...
        tessellator1.draw();
        GL11.glDisable(GL11.GL_TEXTURE_2D);
        float f18 = mc.theWorld.getStarBrightness(partialTicks) * f6;
