			...
			else //Actually generate tree
			{
				...
				if (isSoil && y < 256 - treeHeight - 1)
				{
					...
					for (j2 = 0; j2 < treeHeight; ++j2)
					{
						...
						{
							this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX, trunkY, trunkZ), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
							this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 1, trunkY, trunkZ), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
							this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX, trunkY, trunkZ + 1), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
							this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 1, trunkY, trunkZ + 1), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
							i2 = trunkY;
						}
					}

					//Genthe root
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX - 1, y, trunkZ), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 2, y, trunkZ), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 2, y, trunkZ + 1), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX - 1, y, trunkZ + 1), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());

					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX, y, trunkZ - 1), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 1, y, trunkZ - 1), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 1, y, trunkZ + 2), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX, y, trunkZ + 2), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());

					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX, y, trunkZ), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 1, y, trunkZ), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX, y, trunkZ +1 ), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
					this.setBlockAndNotifyAdequately(world, new BlockPos(trunkX + 1, y, trunkZ + 1), AdvancedRocketryBlocks.blockLightwoodWood.getDefaultState());
