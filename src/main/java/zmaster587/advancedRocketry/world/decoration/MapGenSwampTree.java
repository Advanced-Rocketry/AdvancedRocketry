    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        for (double yAngle = 0; yAngle < 2 * Math.PI; yAngle += Math.PI / 8.0) {
            ...
            for (double angle = 1.5 * Math.PI / 2.0; angle > -Math.PI / 6.0; angle -= Math.PI / 40.0) {
                ...
                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5); //meta
                world.setBlockState(new BlockPos(x + 3 + xx - xOffset - radius / 2, yyy, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5); //meta
                world.setBlockState(new BlockPos(x + 1 + xx - xOffset - radius / 2, yyy, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5); //meta
                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5); //meta
                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset + 1), Blocks.LOG.getDefaultState(), 5); //meta
                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset - 1), Blocks.LOG.getDefaultState(), 5); //meta
            ...
            if (rand.nextInt(4) == 0) {
                ...
                for (int yyyy = 0; yyyy < 10; yyyy++) {
                    ...
                    for (zz = -2; zz < 3; zz++)
                        for (xx = -2; xx < 3; xx++)
                            world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, y + treeHeight - yyyy + yy - yOffset + 2, z + zz - zOffset), Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false), 5);
                    xx = xxx;
                    zz = zzz;
                    int yModified = yyy - yyyy;

                    world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(new BlockPos(x + 3 + xx - xOffset - radius / 2, yModified, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(new BlockPos(x + 1 + xx - xOffset - radius / 2, yModified, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified + 1, z + zz - zOffset), Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified, z + zz - zOffset + 1), Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified, z + zz - zOffset - 1), Blocks.LOG.getDefaultState(), 5);
                }
            }
