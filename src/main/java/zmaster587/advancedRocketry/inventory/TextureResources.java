...
public class TextureResources {
	...
	public static final  ResourceLocation buttonKill[] = {new ResourceLocation("advancedrocketry", "textures/gui/buttons/kill.png"), new ResourceLocation("libvulpes", "textures/gui/buttons/kill_hover.png"), null, null};
	public static final  ResourceLocation buttonCopy[] = {new ResourceLocation("advancedrocketry", "textures/gui/buttons/copy.png"), new ResourceLocation("libvulpes", "textures/gui/buttons/copy_hover.png"), null, null};
