...
public class ItemMultiData extends Item {
	...
	public void setMaxData(@NotNull ItemStack stack, int amount) {
	...
	public int getData(@NotNull ItemStack stack, DataStorage.DataType type) {
	...
	private MultiData getDataStorage(@NotNull ItemStack item) {
	...
	public boolean isFull(@NotNull ItemStack item,  DataStorage.DataType dataType) {
