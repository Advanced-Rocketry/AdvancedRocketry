...
public class BlockPressurizedFluidTank extends Block {
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return new TilePressurizedTank(64000);
	}
	...
	public void harvestBlock(World world, PlayerEntity player, BlockPos pos, BlockState state, TileEntity te, ItemStack stack) {
		...
		if(te instanceof TilePressurizedTank) {
	...
	public void onNeighborChange(BlockState state, IWorldReader world, BlockPos pos, BlockPos neighbor) {
		...
		if(tile instanceof TilePressurizedTank)
			((TilePressurizedTank)tile).onAdjacentBlockUpdated(Direction.getFacingFromVector(neighbor.getX() - pos.getX(), neighbor.getY() - pos.getY(), neighbor.getZ() - pos.getZ()));
	}
}
