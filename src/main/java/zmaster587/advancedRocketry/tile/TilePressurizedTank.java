...
public class TilePressurizedTank extends TileFluidHatch {
	...
	public int fill(FluidStack resource, FluidAction doFill) {
		...
		TilePressurizedTank handler2 = this.getFluidTankInDirection(Direction.UP);
	...
	private int fillInternal2(FluidStack resource, FluidAction doFill) {
		...
		TilePressurizedTank handler = this.getFluidTankInDirection(Direction.DOWN);
	...
	public TilePressurizedTank getFluidTankInDirection(Direction direction) {
		TileEntity tile = world.getTileEntity(pos.offset(direction));

		if(tile instanceof TilePressurizedTank) {
			return ((TilePressurizedTank) tile);
		}
		return null;
	}
	...
	public void onAdjacentBlockUpdated(Direction dir) {
		...
		TilePressurizedTank tank = getFluidTankInDirection(Direction.UP);
