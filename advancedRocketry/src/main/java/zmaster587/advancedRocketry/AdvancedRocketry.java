...
import zmaster587.advancedRocketry.block.BlockScaffolding;
...
public class AdvancedRocketry {
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		launchpad = new BlockScaffolding(Material.rock).setBlockName("pad").setCreativeTab(CreativeTabs.tabTransport);//new BlockMulti(Material.rock).setNames(new String[] {"concrete", "launchtower"});
		structureTower = new BlockScaffolding(Material.rock).setBlockName("tower").setCreativeTab(CreativeTabs.tabTransport);
